...
var FileManager = require("../bin/filesManager.")
...
//  console.log(JSON.stringify(req.body,null,2))
    ...
    if (req.body.getFileContent) {
        ...
        FileManager.getFileContent(req.body.fileName, function (err, result) {
            processResponse(response, err, result)
        })
    }

    if (req.body.saveFile) {
        FileManager.saveFile(req.body.fileName, req.body.content, function (err, result) {
            processResponse(response, err, result)
        })
    }
})
